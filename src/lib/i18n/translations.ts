...
const translations = {
  de: {
    ...
    featuredPage: "Frontpage Display",
    customers: "Kunden",
    analytics: "Analysen",
    discounts: "Rabatte",
    ...
    advertising: "Werbung",
    campaigns: "Kampagnen",
    advertisedProducts: "Beworbene Produkte",
    merchantFeed: "Merchant Feed",
    dailyBudget: "Tagesbudget",
    adTotalSpent: "Gesamtausgaben",
    impressionsLabel: "Impressionen",
    clicksLabel: "Klicks",
    conversionsLabel: "Conversions",
    ctr: "Klickrate",
    conversionRate: "Conversion-Rate",
    costPerClick: "Kosten pro Klick",
    adRevenue: "Werbeeinnahmen",
    roas: "ROAS",
    adPriority: "Priorität",
    adKeywords: "Keywords",
    adCustomTitle: "Anzeigentitel",
    adCustomDescription: "Anzeigenbeschreibung",
    adGoogleCategory: "Google-Kategorie",
    adMaxCpc: "Max. CPC",
    adPaused: "Pausiert",
    adActive: "Aktiv",
    feedUrl: "Feed-URL",
  ...
  en: {
    ...
    campaigns: "Campaigns",
    advertisedProducts: "Advertised Products",
    merchantFeed: "Merchant Feed",
    dailyBudget: "Daily Budget",
    adTotalSpent: "Total Ad Spend",
    ...
    adPriority: "Priority",
    adKeywords: "Keywords",
    adCustomTitle: "Ad Title",
    adCustomDescription: "Ad Description",
    adGoogleCategory: "Google Category",
    adMaxCpc: "Max CPC",
    adPaused: "Paused",
    adActive: "Active",
    feedUrl: "Feed URL",
