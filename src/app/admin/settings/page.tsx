...
const tabSettingKeys: Record<TabKey, string[]> = {
  ...
  backup: ["backup_local_path", "backup_retention_count", "backup_s3_bucket", "backup_s3_region", "backup_s3_key", "backup_s3_secret", "backup_s3_endpoint"],
...
const settingLabels: Record<string, { de: string; en: string }> = {
  ...
  backup_local_path: { de: "Lokaler Backup-Pfad", en: "Local Backup Path" },
  backup_retention_count: { de: "Aufbewahrung (Anzahl)", en: "Retention (Count)" },
